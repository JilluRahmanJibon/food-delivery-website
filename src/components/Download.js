...
const Download = () => {
    return (
        <div style={{ backgroundImage: `url(${download})`,backgroundPosition:'cover', backgroundRepeat:'no-repeat',backgroundSize:'cover' }} className='h-[516px] flex items-center justify-center w-full'>
